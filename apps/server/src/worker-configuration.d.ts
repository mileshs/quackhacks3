/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/server/src/worker-configuration.d.ts --config wrangler.jsonc` (hash: 658334be56caf23f1a138a529b0d312f)
// Runtime types generated with workerd@1.20260526.1 2026-05-31 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	GLOBAL_GAME: DurableObjectNamespace<import("./index").GlobalGame>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "GlobalGame";
	}
